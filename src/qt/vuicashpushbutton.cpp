...
VuiCashPushButton::VuiCashPushButton(const QString &text, QWidget *parent):
    QPushButton(text, parent),
    m_iconCached(false)
{}

void VuiCashPushButton::paintEvent(QPaintEvent *)
{
...
void VuiCashPushButton::updateIcon(QStyleOptionButton &pushbutton)
{
    // Update sunken icon
