...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000002ee39fbaf66506e5c57"); // vuicash
        ...
        vSeeds.emplace_back("vuicash3.dynu.net"); // VuiCash mainnet
        vSeeds.emplace_back("vuicash5.dynu.net"); // VuiCash mainnet
        vSeeds.emplace_back("vuicash6.dynu.net"); // VuiCash mainnet
        vSeeds.emplace_back("vuicash7.dynu.net"); // VuiCash mainnet
        ...
        consensus.nSubsidyHalvingIntervalV2 = consensus.nBlocktimeDownscaleFactor*985500; // vuicash halving every 4 years (nSubsidyHalvingInterval * nBlocktimeDownscaleFactor)
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000f64ad2ae9a92bd2de8"); // vuicash
        ...
        vSeeds.emplace_back("vuicash4.dynu.net"); // VuiCash testnet
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // VUI have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
...
{
    return dev::eth::Network::vuicashMainNetwork;
}
