...
inline dev::Address createVuiCashAddress(dev::h256 hashTx, uint32_t voutNumber){
...
inline VuiCashTransaction createVuiCashTransaction(valtype data, dev::u256 value, dev::u256 gasLimit, dev::u256 gasPrice, dev::h256 hashTransaction, dev::Address recipient, int32_t nvout = 0){
