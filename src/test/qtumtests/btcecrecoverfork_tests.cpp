...
//    initState();
    ...
    std::vector<VuiCashTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createVuiCashTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createVuiCashTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createVuiCashTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createVuiCashTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
