...
void VuiCashDGP::initDataSchedule(){
    dataSchedule = scheduleDataForBlockNumber(0);
}

bool VuiCashDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData, int blockHeight){
...
dev::eth::EVMSchedule VuiCashDGP::getGasSchedule(int blockHeight){
    clear();
...
dev::eth::EVMSchedule VuiCashDGP::createEVMSchedule(const dev::eth::EVMSchedule &_schedule, int blockHeight){
