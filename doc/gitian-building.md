...
git clone https://github.com/vuicash/gitian.sigs.git
```
...
cd /some/root/path/
git clone https://github.com/vuicash/vuicash-detached-sigs.git
...
[vuicash/gitian.sigs](https://github.com/vuicash/gitian.sigs/) repository, or if that's not possible create a pull
