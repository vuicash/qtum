...
* [Qtum-Qt Wallet Tutorial](https://github.com/vuicash/documents/tree/master/en/Qtum-Wallet-Tutorial#qtum-qt-wallet-tutorial)
* [Qtum staking tutorial](https://github.com/vuicash/documents/tree/master/en/How-to-Stake-with-Qtum)
* [Qtum tutorial on Raspberry Pi](https://github.com/vuicash/documents/tree/master/en/Qtum-on-Raspberry-Pi)
* [Running Qtum on Amazon AWS using Qtum AMI](https://github.com/vuicash/documents/tree/master/en/Qtum-AWS)
* [Encrypting and unlocking wallet](https://github.com/vuicash/documents/tree/master/en/Encrypt-and-Unlock-Qtum-Wallet)
...
* [QtumJS document](https://vuicash.github.io/qtumjs-doc/)
...
Qtum uses a tool called Gitian to make reproducible builds that can be verified by anyone. Instructions on setting up a Gitian VM and building Qtum are provided in [Gitan Building](https://github.com/vuicash/qtum/blob/master/doc/gitian-building.md)
...
Here is a brief description for compiling Qtum on CentOS, for more details please refer to [the specific document](https://github.com/vuicash/qtum/blob/master/doc/build-unix.md)
